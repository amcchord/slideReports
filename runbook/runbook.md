# {{SYSTEM_NAME}} Disaster Recovery Runbook
...
#### Server 1 - Critical Infrastructure
| Component | Details |
|-----------|---------|
| **🏷️ Hostname** | {{PRIMARY_SERVER1_HOSTNAME}} |
| **🌐 IP Address** | {{PRIMARY_SERVER1_IP}} |
| **⚙️ Role/Function** | {{PRIMARY_SERVER1_ROLE}} |
...
#### Server 2 - Important Services
| Component | Details |
|-----------|---------|
| **🏷️ Hostname** | {{SECONDARY_SERVER1_HOSTNAME}} |
| **🌐 IP Address** | {{SECONDARY_SERVER1_IP}} |
| **⚙️ Role/Function** | {{SECONDARY_SERVER1_ROLE}} |
...
#### Server 3 - Non-Critical Services
| Component | Details |
|-----------|---------|
| **🏷️ Hostname** | {{OPTIONAL_SERVER1_HOSTNAME}} |
| **🌐 IP Address** | {{OPTIONAL_SERVER1_IP}} |
| **⚙️ Role/Function** | {{OPTIONAL_SERVER1_ROLE}} |
...
| **🛠️ Management Network** | {{MGMT_NETWORK_RANGE}} |
| **🔒 DMZ Network** | {{DMZ_NETWORK_RANGE}} |

### Key Network Devices
| Device | IP Address |
|--------|------------|
| **🛣️ Primary Router** | {{PRIMARY_ROUTER_IP}} |
| **🔄 Core Switch** | {{CORE_SWITCH_IP}} |
| **🛡️ Firewall** | {{FIREWALL_IP}} |
...
> ⚠️ **NOTICE:** This document contains sensitive information. Handle according to company security policies.
